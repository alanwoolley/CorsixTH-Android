...
//    private boolean globalAudio, playMusic, playAnnouncements, playSoundFx, keepScreenOn, debug, edgeScroll, adviser, playMovies, playIntroMovie, spen, autoWageGrant, haptic, hapticEarthquakes;
//    private int musicVol, announcementsVol, sfxVol, resolutionMode, displayWidth, displayHeight, gameSpeed, fpsLimit, edgeBordersSize, edgeScrollSpeed, controlsMode, nativeWidth, nativeHeight;
//    private String saveGamesPath = Files.Companion.getExtStoragePath() + "CTHsaves";
...
//     */
//    public static Configuration loadFromPreferences(Context ctx, SharedPreferences preferences) throws StorageUnavailableException, IOException {
...
//        cthPath = preferences.getString("gamescripts_pref", ctx.getExternalFilesDir(null).getCanonicalPath());
//
...
//        announcementsVol = Integer.valueOf(preferences.getString("announcervolume_pref", "5"));
//        musicVol = Integer.valueOf(preferences.getString("musicvolume_pref", "5"));
//
//        language = preferences.getString("language_pref", "en");
//
//        resolutionMode = Integer.valueOf(preferences.getString("resolution_pref", "1"));
//
...
//        edgeBordersSize = Integer.valueOf(preferences.getString("edgebordersize_pref", "20"));
//        edgeScrollSpeed = Integer.valueOf(preferences.getString("edgescrollspeed_pref", "15"));
//
//        // Movies
...
//        controlsMode = Integer.valueOf(preferences.getString("controlsmode_pref", "1"));
//
...
//
//        if (preferences.getString("fpslimit_pref", "20").equals(ctx.getString(R.string.off))) {
//            fpsLimit = 0;
//        } else {
...
//
//                float ratio = Math.max(((float) MINIMUM_HEIGHT / nativeHeight), ((float) MINIMUM_WIDTH / nativeWidth));
//
//                displayWidth = (int) (nativeWidth * ratio);
//                displayHeight = (int) (nativeHeight * ratio);
//                Log.d("Adjusted resolution is: " + displayWidth + " x " + displayHeight);
//                break;
//
...
//                displayWidth = Integer.valueOf(preferences.getString("reswidth_pref", String.valueOf(MINIMUM_WIDTH)).trim());
//                displayHeight = Integer.valueOf(preferences.getString("resheight_pref", String.valueOf(MINIMUM_HEIGHT)).trim());
//                break;
//
//        }
//    }
...
//        return "Configuration [origFiles=" + originalFilesPath + ", cthPath=" + cthPath + ", Audio?=" + globalAudio + ", Music?=" + playMusic + ", Announcements?=" + playAnnouncements + ", SFX?=" + playSoundFx + ", mVol=" + musicVol + ", aVol=" + announcementsVol + ", sfxVol=" + sfxVol + ", language=" + language + ", resMode=" + resolutionMode + ", width=" + displayWidth + ", height=" + displayHeight + ", debug?=" + debug + "]";
//    }
//
